export type SQLString = {
    /**
     * appends more template strings and values to this {@link SQLString } and returns a reference to it
     */
    append: typeof SQL;
    /**
     * the text of the {@link SQLString } with values replaced by bind parameters ($1, $2, ...)
     */
    text: string;
    /**
     * the SQL of the {@link SQLString } with bind parameters (?) instead of values
     */
    sql: string;
    /**
     * the values of the {@link SQLString } to be inserted into the SQL
     */
    values: any[];
    /**
     * yields the SQL and values of the {@link SQLString } one by one
     */
 ...
 * ```
 */
export function SQL(template: string[] | string, ...values: any[]): SQLString;
export namespace SQL {
    export { SEQUELIZE_USE_BIND };
}
/**
 * @type {Symbol} pass to the SQL function to use bind parameters ($1, $2, ...) instead of client replacements with sequalize
 */
declare const SEQUELIZE_USE_BIND: Symbol;
export {};
